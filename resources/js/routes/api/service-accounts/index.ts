...
/**
* @see \App\Http\Controllers\Api\ServiceAccountController::rotate
* @see app/Http/Controllers/Api/ServiceAccountController.php:125
* @route '/api/service-accounts/{serviceAccount}/rotate'
*/
export const rotate = (args: { serviceAccount: number | { id: number } } | [serviceAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/api/service-accounts/{serviceAccount}/rotate'
*/
rotate.url = (args: { serviceAccount: number | { id: number } } | [serviceAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { serviceAccount: args }
    }
...
* @route '/api/service-accounts/{serviceAccount}/rotate'
*/
rotate.post = (args: { serviceAccount: number | { id: number } } | [serviceAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: rotate.url(args, options),
    method: 'post',
})
...
* @route '/api/service-accounts/{serviceAccount}/rotate'
*/
const rotateForm = (args: { serviceAccount: number | { id: number } } | [serviceAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/api/service-accounts/{serviceAccount}/rotate'
*/
rotateForm.post = (args: { serviceAccount: number | { id: number } } | [serviceAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: rotate.url(args, options),
    method: 'post',
})
