...
getUserContacts.url = (
    ...
    return (
        getUserContacts.definition.url
            .replace('{user}', parsedArgs.user.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
createUserContact.url = (
    ...
    return (
        createUserContact.definition.url
            .replace('{user}', parsedArgs.user.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
export const deleteUserContact = (
    args:
        | { user: number | { id: number }; contact: number | { id: number } }
        | [user: number | { id: number }, contact: number | { id: number }],
    options?: RouteQueryOptions,
...
deleteUserContact.url = (
    ...
    return (
        deleteUserContact.definition.url
            .replace('{user}', parsedArgs.user.toString())
