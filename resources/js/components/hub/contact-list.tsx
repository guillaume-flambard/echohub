            ...
            <div className="border-b border-sidebar-border p-3">
                ...
                >
                    ...
                    <Button
                        ...
                        className="h-7 text-xs"
                        aria-pressed={filterType === 'app'}
                        aria-label="Show app contacts only"
                    >
                        Apps
                    </Button>
                    <Button
                        ...
                        className="h-7 text-xs"
                        aria-pressed={filterType === 'human'}
                        aria-label="Show human contacts only"
                    >
                        Humans
                    </Button>
                </div>
...
// Memoized ContactItem to prevent unnecessary re-renders with expensive animations
const ContactItem = memo(
    ({ contact, isSelected, onClick }: ContactItemProps) => {
        const statusColor =
        ...
        return (
            <motion.button
                ...
                role="listitem"
                aria-label={`${contact.name}${contact.type === 'app' ? ', Minerva app' : ', human contact'}${contact.app?.status ? `, status: ${contact.app.status}` : ''}`}
    ...
    // Custom comparison: only re-render if contact ID or selection status changes
    (prevProps, nextProps) =>
